...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        pushButton_envSetup = new QPushButton(verticalLayoutWidget);
        pushButton_envSetup->setObjectName(QStringLiteral("pushButton_envSetup"));

        verticalLayout->addWidget(pushButton_envSetup);

        pushButton_getRandom = new QPushButton(verticalLayoutWidget);
        pushButton_getRandom->setObjectName(QStringLiteral("pushButton_getRandom"));

        verticalLayout->addWidget(pushButton_getRandom);
